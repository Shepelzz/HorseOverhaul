...
public class MessageConfig extends AbstractConfig {
    ...
    protected void addDefaults() {
        ...
        customFile.addDefault("horse.interaction.neutered-not-owner",  "<red>Нужно сделать документы на лошать, прежде чем проводить стерелизацию!");
